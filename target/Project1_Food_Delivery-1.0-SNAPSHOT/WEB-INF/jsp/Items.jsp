<%-- 
    Document   : Items
    Created on : Feb 16, 2023, 8:29:08 PM
    Author     : mrina
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto" style="display: flex; align-items: center">
                        <li class="nav-item">
                            <a class="nav-link nav-reg" href="login">
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-reg" href="offers">
                                <span class="material-symbols-outlined nav-icons">
                                    loyalty
                                </span>
                                Offers
                        ...
                        <li class="nav-item">
                            <a class="nav-link nav-reg" href="restaurants">
                        ...
                        %>
                        <li class="nav-item">
                            <a class="nav-link nav-reg" href="register">
                                <span class="material-symbols-outlined nav-icons">
                                    person
                                </span>
                                Sign Up
                        ...
                        <li class="nav-item">
                            <button id="openSidebarBtn" class="nav-link nav-reg"><span class="material-symbols-outlined nav-icons">
                                    shopping_cart
                                </span>
                                Cart
                            </button>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-head">
                ...
                <div style="text-align: right;display: inline-block">
                    <button type="button" data-bs-dismiss="sidebar" class="btn-close"></button>
                </div>
                <hr>
            </div>
